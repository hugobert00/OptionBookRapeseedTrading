...
rapseed_contract_info = {
    "Rapseed Euronext": {
        ...
        "tick_size": 0.0025,
        "tick_value": 12.50,
        "expiration_months":["H", "M", "Q", "X" ],
        "termination": "3rd Friday of each expiry month"
    }
}
...
BASE_PATH_3 = Path("/Users/hugoberthelier/Desktop/PricerLB/vol/")
...
builded_strategies = {
    "None (Manual Input)": [{"Type": "Call", "Quantity": 1, "Strike/fut price": 450}],
    "Call Spread": [{"Type": "Call", "Quantity": 1, "Strike/fut price": 450},
                     {"Type": "Call", "Quantity": -1, "Strike/fut price": 460}],
    "Put Spread": [{"Type": "Put", "Quantity": 1, "Strike/fut price": 450},
                    {"Type": "Put", "Quantity": -1, "Strike/fut price": 440}],
    "Short Call Spread":[{"Type": "Call", "Quantity": -1, "Strike/fut price": 450},
                     {"Type": "Call", "Quantity": 1, "Strike/fut price": 460}],
    "Short Put Spread":[{"Type": "Put", "Quantity": -1, "Strike/fut price": 450},
                    {"Type": "Put", "Quantity": 1, "Strike/fut price": 440}],
    "Covered Write": [{"Type": "fut", "Quantity": 1, "Strike/fut price": 450},
                       {"Type": "Call", "Quantity": -1, "Strike/fut price": 450}],
    "Protective Put": [{"Type": "fut", "Quantity": 1, "Strike/fut price": 450},
                        {"Type": "Put", "Quantity": 1, "Strike/fut price": 450}],
    "Long Straddle": [{"Type": "Call", "Quantity": 1, "Strike/fut price": 450},
                       {"Type": "Put", "Quantity": 1, "Strike/fut price": 450}],
    "Long Strangle": [{"Type": "Call", "Quantity": 1, "Strike/fut price": 460},
                       {"Type": "Put", "Quantity": 1, "Strike/fut price": 450}],
    "Short Straddle": [{"Type": "Call", "Quantity": -1, "Strike/fut price": 450},
                        {"Type": "Put", "Quantity": -1, "Strike/fut price": 450}],
    "Short Strangle": [{"Type": "Call", "Quantity": -1, "Strike/fut price": 460},
                       {"Type": "Put", "Quantity": -1, "Strike/fut price": 450}],
    "Long Call Butterfly": [{"Type": "Call", "Quantity": 1, "Strike/fut price": 440},
                             {"Type": "Call", "Quantity": -2, "Strike/fut price": 450},
                             {"Type": "Call", "Quantity": 1, "Strike/fut price": 460}],
    "Short Call Butterfly": [{"Type": "Call", "Quantity": -1, "Strike/fut price": 440},
                              {"Type": "Call", "Quantity": 2, "Strike/fut price": 450},
                              {"Type": "Call", "Quantity": -1, "Strike/fut price": 460}],
}
...
if Menu == 'Main Book':
    ...
    st.write(f'Welcome on your Rapeseed Book Laurent!')
    st.subheader(f'Rapeseed Book overview - Opened positions - Acc:{selected_account}')
...
if Menu == 'Closed Positions & PNL Reports':
    ...
    # Extra info
    # ===============================
    st.write("PnL on FX Exposure: **NO EXPOSURE** (Euronext Rapeseed traded in EUR)")
...
if Menu == 'Volatility tools':
    ...
    st.write("Volatility smile for Rapeseed for all available expiries")
    ...
    fig_surface = plot_vol_surface(
        ...
        title="Implied vol surface - Rapeseed"
    )
    ...
    st.write("Please manually verify implied vol data (source files in /PricerLB/vol).")
...
if Menu == 'Pricer - Strategy':
    ...
    st.subheader("Pricer - Build your strategy here - Rapeseed")
    st.write("Welcome on your Rapeseed pricer Laurent - Please enter your strategy below :")
    st.sidebar.subheader("Market inputs")
    valuation_date = st.sidebar.date_input("Valuation date",value=date.today())
